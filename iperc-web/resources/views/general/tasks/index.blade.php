...
<div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
    <div class="statbox widget box box-shadow">
        <div class="widget-header py-3 px-3">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="btn btn-danger" data-toggle="modal" data-target="#create">Nueva Nueva</div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('tarea.save') }}" method="POST">
                @csrf
    ...
    $('body').on('click', '.table-edit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#activity').val(response.activity_id);
            },
