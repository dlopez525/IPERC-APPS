...
<div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
    <div class="statbox widget box box-shadow">
        <div class="widget-header py-3 px-3">
            <div class="row">
                <div class="col-12">
                    <h4>Descripciones de Peligro</h4>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-12">
                    <div class="btn btn-danger" data-toggle="modal" data-target="#create">Nueva Descripción de Peligro</div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Descripción del Peligro</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                  </button>
            </div>
            <form action="{{ route('description.save') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" id="el_id" name="el_id">
                        <label for="name">Peligro</label>
                        <select name="danger" id="danger" class="form-control" required>
                            <option value="">Selecciona un Peligro</option>
                    ...
                    <div class="form-group">
                        <label for="description">Descripción del Peligro</label>
                        <textarea name="description" id="description" class="form-control" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="event">Evento Peligroso</label>
...
<script>
    ...
    $('body').on('click', '.table-cancel', function(e) {
        ...
        if (confirm('¿Desea Eliminar este Elemento?')) {
            $.ajax({
                type: 'post',
                url: '/peligros/descripcion/delete',
                data: {
                    _token: '{{ csrf_token() }}',
                    el: id 
                },
